        ...
        <v-col>
            ...
            >
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            <Number label="ContentAnalyzerId" v-model="selectedRow.contentAnalyzerId" :editMode="true"/>
                            ...
                            <GerationStatus offline label="Status" v-model="selectedRow.status" :editMode="true"/>
